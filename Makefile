# This Makefile is for the Text::Names extension to perl.
#
...
#     ABSTRACT_FROM => q[lib/Text/Names.pm]
#     AUTHOR => q[David Bourget <dbourget@>]
#     BUILD_REQUIRES => {  }
#     NAME => q[Text::Names]
#     PREREQ_PM => {  }
#     VERSION_FROM => q[lib/Text/Names.pm]
...
PARENT_NAME = Text
DLBASE = $(BASEEXT)
VERSION_FROM = lib/Text/Names.pm
OBJECT = 
LDFROM = $(OBJECT)
LINKTYPE = dynamic
BOOTDEP = 
...
TO_INST_PM = lib/Text/Names.pm

PM_TO_BLIB = lib/Text/Names.pm \
...
manifypods : pure_all  \
	...
	$(NOECHO) $(POD2MAN) --section=$(MAN3EXT) --perm_rw=$(PERM_RW) \
	  lib/Text/Names.pm $(INST_MAN3DIR)/Text::Names.$(MAN3EXT) 
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) 'name:               Text-Names' >> META_new.yml
	$(NOECHO) $(ECHO) 'version:            0.01' >> META_new.yml
	$(NOECHO) $(ECHO) 'abstract:           Perl extension for name parsing and normalization' >> META_new.yml
...
ppd :
	...
	$(NOECHO) $(ECHO) '    <ABSTRACT>Perl extension for name parsing and normalization</ABSTRACT>' >> $(DISTNAME).ppd
...
pm_to_blib : $(FIRST_MAKEFILE) $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', q[$(PM_FILTER)], '\''$(PERM_DIR)'\'')' -- \
	  lib/Text/Names.pm blib/lib/Text/Names.pm 
